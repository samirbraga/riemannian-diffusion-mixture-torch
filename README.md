...
📂 Sobre o Dataset
Fonte: CATH (Class, Architecture, Topology, Homologous superfamily)
Versão Específica: cath-dataset-nonredundant-S40
Download: cath-dataset-nonredundant-S40.pdb.tgz
🚀 
...
Instruções:
Descompacte o arquivo cath-dataset-nonredundant-S40.pdb.tgz.
Crie um diretório chamado dompdb na raiz do projeto.
Mova todos os arquivos .pdb descompactados para dentro da pasta dompdb.
