...
from foldingdiff.bin.train import get_train_valid_test_sets

from foldingdiff.angles_and_coords import get_pdb_length, filter_amino_acids
...
def count_structures_in_pdb(
    ...
    if backend == "psea":
        ...
        atom_array = source_struct[
            (source_struct.chain_id == chain_id) & filter_amino_acids(source_struct)
        ]
        ss = struc.annotate_sse(atom_array)
